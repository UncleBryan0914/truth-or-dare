...
const MIN_GAP_N = 6;
const MAX_GAP_N = 16;
const PLAY_MODE_GROUP_SCALE = 1.28;
const DESKTOP_UI_FONT_SCALE = 1.44;
const DESKTOP_PRIMARY_BTN_SCALE = 1.2;
const DESKTOP_NEW_BTN_EXTRA_SCALE = 1.296;
const DESKTOP_MANAGE_BTN_EXTRA_SCALE = 1.32;
...
const MOBILE_PRIMARY_BTN_SCALE = 1.6;
const MOBILE_BASE_UI_FONT_REM = 0.72;
const MOBILE_UI_FONT_SCALE = 1.4;
const DEFAULT_UI_FONT_REM = MOBILE_BASE_UI_FONT_REM * MOBILE_UI_FONT_SCALE;
...
function applyDesktopToolbarLayout() {
  ...
  if (els.btnManageTemp) {
    ...
    root.style.setProperty(
      '--desktop-btn-manage-w',
      `${Math.ceil(baseW * DESKTOP_PRIMARY_BTN_SCALE * DESKTOP_MANAGE_BTN_EXTRA_SCALE)}px`
    );
  }
